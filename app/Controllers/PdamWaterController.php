...
class PdamWaterController extends BaseController
{
  ...
  public function exportExcel()
  {
    ...
    $sheet->setCellValue('A1', 'LAPORAN PENGECEKAN AIR PDAM');
    ...
    $filename = "PDAM_Water_Report_{$year}_{$month}.xlsx";
  ...
  public function exportPdf()
  {
    ...
    $html = view('pdam_water/export_pdf', [
      'title' => 'Laporan Pengecekan Air PDAM',
    ...
    return $this->response
      ...
      ->setHeader('Content-Disposition', 'inline; filename="PDAM_Water_Report_' . $year . '_' . $month . '.pdf"')
