...
$backUrl = '/pdam-water?monthpicker=' . rawurlencode($monthRef);
  ...
  <section class="card utility-hero-card no-lift mb-3">
    <div class="card-body d-flex flex-wrap justify-content-between align-items-start gap-3">
      <div>
        ...
        <h5 class="mb-1 fw-bold">Detail Pengecekan Air PDAM</h5>
...
<script>
  (() => {
    const date = "<?= esc($date) ?>";
    const saveUrl = "/pdam-water/save";
    const deleteUrl = "/pdam-water/delete";
