...
$ramSlots = device_ram_slots_display($device);
$diskList = device_disks_display($device);
...
<div class="it-shell" data-it-device-state='<?= esc(json_encode($liveState, JSON_UNESCAPED_UNICODE), 'attr') ?>'>
    <section class="card border-0 shadow-sm no-lift it-hero-card mb-3">
        <div class="card-body d-flex flex-wrap justify-content-between align-items-start gap-4">
            <div class="it-hero-copy">
                ...
                <div class="it-hero-links">
                    <a href="/it/devices" class="btn btn-sm btn-outline-secondary it-quick-btn">
                        <i class="bi bi-arrow-left me-1"></i> Daftar Device
                    </a>
                    <a href="/it-assets" class="btn btn-sm btn-outline-primary it-quick-btn">
                        <i class="bi bi-pc-display me-1"></i> Inventaris IT
                    </a>
                    <?php if ($asset): ?>
                        <a href="/it-assets/detail/<?= (int) $asset['id'] ?>" class="btn btn-sm btn-outline-dark it-quick-btn">
                            <i class="bi bi-box-arrow-up-right me-1"></i> Asset Terkait
                        </a>
                    <?php endif; ?>
                </div>
            </div>

            <div class="it-hero-summary">
                <div class="it-summary-grid">
                    ...
                    <div class="it-summary-item">
                        ...
                        <strong><?= esc($assetLabel) ?></strong>
                    </div>
                    <div class="it-summary-item">
                        <span class="it-summary-label">Status Sync</span>
                        <strong><?= esc($syncLabel) ?></strong>
                    </div>
                    <div class="it-summary-item">
                        <span class="it-summary-label">Status Lisensi</span>
                        <strong><?= esc($activationLabel) ?></strong>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-3">
        <div class="col-lg-4">
            <section class="card border-0 shadow-sm no-lift h-100 it-stack-card">
                <div class="card-header bg-transparent border-0 pb-0">
                    <p class="it-card-eyebrow mb-1">Live Status</p>
        ...
        <div class="col-lg-8">
            <section class="card border-0 shadow-sm no-lift h-100 it-stack-card">
                <div class="card-header bg-transparent border-0 pb-0">
                    <p class="it-card-eyebrow mb-1">Remote Action</p>
                ...
                <div class="card-body pt-2">
                    ...
                    <?php endif; ?>
                    <div class="it-command-group">
                        <div class="it-command-group-title">Aksi sistem</div>
                    ...
                    <div class="it-command-group">
                        <div class="it-command-group-title">Aksi sesi pengguna</div>
                        <div class="it-command-grid">
                    ...
                    <div class="it-command-group mb-0">
                        <div class="it-command-group-title">Utilitas</div>
                        <div class="it-command-grid">
                            ...
                            <button class="btn btn-outline-secondary" onclick="window.open('/downloads/logs/<?= esc($device['device_token'] ?? '') ?>.log', '_blank')">
    ...
    <div class="row g-3 mt-0">
        <div class="col-lg-5">
            <section class="card border-0 shadow-sm no-lift h-100 it-stack-card">
                <div class="card-header bg-transparent border-0 pb-0">
                    <p class="it-card-eyebrow mb-1">Automatic Review</p>
                ...
                <div class="card-body pt-2">
                    ...
                    <?php else: ?>
                        <div class="alert alert-light border mb-0">Belum ada insight otomatis untuk device ini.</div>
                    <?php endif; ?>
                </div>
            </section>
        </div>
        ...
        <div class="col-lg-7">
            <section class="card border-0 shadow-sm no-lift h-100 it-stack-card">
                <div class="card-header bg-transparent border-0 pb-0">
                    <p class="it-card-eyebrow mb-1">Hardware Profile</p>
                ...
                <div class="card-body pt-2">
                    ...
                    <div class="it-detail-kv"><span>CPU</span><strong><?= esc(device_cpu_label($device)) ?></strong></div>
                    <div class="it-detail-kv"><span>Core / Thread</span><strong><?= esc(device_cpu_core_thread_label($device)) ?></strong></div>
                    <div class="it-detail-kv"><span>GPU</span><strong><?= esc(device_gpu_label($device)) ?></strong></div>
    ...
    <div class="row g-3 mt-0">
        <div class="col-lg-12">
            <section class="card border-0 shadow-sm no-lift h-100 it-stack-card">
                <div class="card-header bg-transparent border-0 pb-0">
                    <p class="it-card-eyebrow mb-1">User Session</p>
    ...
    <div class="row g-3 mt-0">
        <div class="col-lg-6">
            <section class="card border-0 shadow-sm no-lift h-100 it-stack-card">
                <div class="card-header bg-transparent border-0 pb-0">
                    <p class="it-card-eyebrow mb-1">Memory Slot</p>
                    <div class="d-flex align-items-center justify-content-between gap-2">
                        <h6 class="fw-semibold mb-1">Detail RAM</h6>
                        <span class="badge text-bg-light"><?= count($ramSlots) ?></span>
                    </div>
                </div>
                <div class="card-body pt-2">
                    <?php if (!empty($ramSlots)): ?>
                        <ul class="list-group list-group-flush it-list">
                            <?php foreach ($ramSlots as $slotIndex => $ram): ?>
                                <?php
                                $manufacturer = trim((string)($ram['manufacturer'] ?? $ram['display_name'] ?? ''));
                                ...
                                if ($ramSpeed > 0 && empty($ram['is_fallback'])) {
        ...
        <div class="col-lg-6">
            <section class="card border-0 shadow-sm no-lift h-100 it-stack-card">
                <div class="card-header bg-transparent border-0 pb-0">
                    <p class="it-card-eyebrow mb-1">Disk Inventory</p>
                    <div class="d-flex align-items-center justify-content-between gap-2">
                        <h6 class="fw-semibold mb-1">Detail Storage</h6>
                        <span class="badge text-bg-light"><?= count($diskList) ?></span>
                    </div>
                </div>
                <div class="card-body pt-2">
        ...
        <div class="col-lg-4">
            <section class="card border-0 shadow-sm no-lift h-100 it-stack-card">
                <div class="card-header bg-transparent border-0 pb-0">
                    <div class="d-flex align-items-center justify-content-between gap-2">
                        <div>
                            <p class="it-card-eyebrow mb-1">Peripheral</p>
                            <h6 class="fw-semibold mb-1">Keyboard</h6>
                        </div>
                        <span class="badge text-bg-light"><?= count($keyboardList) ?></span>
                    </div>
                </div>
                <div class="card-body pt-2">
            ...
            <section class="card border-0 shadow-sm no-lift h-100 it-stack-card">
                <div class="card-header bg-transparent border-0 pb-0">
                    <div class="d-flex align-items-center justify-content-between gap-2">
                        ...
                        <span class="badge text-bg-light"><?= count($mouseList) ?></span>
                    </div>
                </div>
                <div class="card-body pt-2">
            ...
            <section class="card border-0 shadow-sm no-lift h-100 it-stack-card">
                <div class="card-header bg-transparent border-0 pb-0">
                    <div class="d-flex align-items-center justify-content-between gap-2">
                        ...
                        <span class="badge text-bg-light"><?= count($monitorList) ?></span>
                    </div>
                </div>
                <div class="card-body pt-2">
    ...
    <div class="row g-3 mt-0">
        <div class="col-lg-12">
            <section class="card border-0 shadow-sm no-lift h-100 it-stack-card">
                <div class="card-header bg-transparent border-0 pb-0">
                    <p class="it-card-eyebrow mb-1">Audit Trail</p>
                    ...
                    <?php if (!empty($commandHistory)): ?>
                        <ul class="list-group list-group-flush it-list">
                            <?php foreach ($commandHistory as $commandRow): ?>
                                ...
                                $statusLabel = $statusLabelMap[$commandStatus] ?? ucfirst($commandStatus);
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-start gap-2">
                                        ...
                                        <span class="badge text-bg-<?= esc($statusTone) ?>"><?= esc($statusLabel) ?></span>
                                    </div>
                                </li>
                            <?php endforeach; ?>
                        </ul>
    ...
    <section class="card border-0 shadow-sm no-lift mt-3 it-stack-card">
        <div class="card-header bg-transparent border-0 pb-0">
            <p class="it-card-eyebrow mb-1">Asset Relation</p>
        ...
        <div class="card-body pt-2">
            <?php if ($asset): ?>
                ...
                <a href="/it-assets/detail/<?= (int) $asset['id'] ?>" class="btn btn-sm btn-outline-primary mt-2">
